...
diag "maze containing an 'X' character should fail script 01:\n\n";
diag "$bad_script01_maze";


foreach my $n (1) {
  my $res = get_script_output("../quality-check-script-0$n.sh", $bad_script01_maze);
  chomp $res;
  is($res, 'no',  "quality script $n correctly classifies 5x3 bad maze");
}
